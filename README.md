...
This tasks is to develop a chatbot that can help me decide; it will have a certain persona (helpful assistant), give accurate information about my personal preferences (database of my own entries), give accurate information about other restaurants (yelp api?).
